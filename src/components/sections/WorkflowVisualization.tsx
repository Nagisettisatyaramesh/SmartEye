      ...
      <Container>
        ...
        <div ref={ref} className="relative mt-16 grid gap-x-10 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="pointer-events-none absolute left-[19px] top-2 hidden w-px bg-gradient-to-b from-accent-400 to-brand-400 lg:block"
          />
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="relative z-10 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-white/15 bg-ink-900 text-accent-300">
